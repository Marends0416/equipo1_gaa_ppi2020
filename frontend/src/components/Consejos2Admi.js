...
const Consejos2Admi = (props) => {
  const { history } = props;

return(
<div className="Consejos2Admi">
  <div>
  <>
        <Navbar bg="primary" variant="dark">
          <Navbar.Brand href="#home" onClick={() => history.push("/ConsejosAdmi")}>
            <img
              class="logoC"
              src="./flecha3.png" alt=""
              width="70"
...
<CardGroup>
  ...
  <Card.Img variant="top" src="https://blog.cerdanyaecoresort.com/wp-content/uploads/2018/03/compuestos-org%C3%A1nicos.jpg" width="200" height="160"/>
    ...
    <Card.Footer>
    <Button variant="primary" onClick={() => history.push("/Consejos3Admi")}><img
              class="logoC"
              src="./flecha.png"
              alt=""
              width="70"
...
export default withRouter(Consejos2Admi);
