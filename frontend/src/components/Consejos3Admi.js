...
const Consejos3Admi = (props) => {
  const { history } = props;

return(
<div className="Consejos3Admi">
...
<CardGroup>
  ...
  <Card.Img variant="top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCl-cWUKUUn231MSSfa7pqTqA6VDuSUynAmiP3fuuaLsyu6C5UXnAjg2GVptGW2jNMYZNvwlCHAeUqm1IqCfkMsx8xSltaajX50w&usqp=CAU&ec=45702845" width="150" height="300" />
    ...
    <Card.Footer>
    <Button variant="primary" onClick={() => history.push("/ConsejosAdmi")}>Regresar</Button><Button variant="outline-primary" onClick={() => history.push("/Consejos3Admi")}>Probaré este consejo</Button>
    </Card.Footer>
  </Card>
</CardGroup>
...
export default withRouter(Consejos3Admi);
