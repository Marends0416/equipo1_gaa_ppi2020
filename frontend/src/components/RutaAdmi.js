...
import '../style/RutaAdmi.css'
import { withRouter } from "react-router-dom";

const RutaAdmi = (props) => {
  const { history } = props;
  return(
<div className="RutaAdmi">
...
<br/>
  <br/>
  <br/>
  <button class="btn btn-lg btn-primary btn-block" type="submit" onClick={() => history.push("/PreguntasAdmi")}>Jugar</button>
...
export default withRouter(RutaAdmi);
