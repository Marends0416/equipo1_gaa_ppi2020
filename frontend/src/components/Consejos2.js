...
import { CardGroup,Card, Button, Navbar, FormControl, Form, Modal, ModalHeader, ModalBody, ModalFooter} from 'react-bootstrap';
...
const url = "http://localhost:3306/Consejos2/";
  ...
  class Consejos2 extends React.Component {
    constructor() {
      super();
      this.state = {
        data: [],
      ...
      return (
        <div className="">
          <div>
            <>
              <Navbar bg="primary" variant="dark">
                ...
                <button className="btn btn-success" onClick={() => { this.setState({ form: null, tipoModal: 'insertar' }); this.modalInsertar() }}>Agregar consejos</button>
              </Navbar>
            </>
          </div>
          ...
          <Modal isOpen={this.state.modalEliminar}>
            <ModalBody>
              Está seguro de eliminar el consejo {form && form.tipo}
            </ModalBody>
            <ModalFooter>
